...
function App() {
  ...
  return (
    ...
    <header>
      ...
      <h2>A ttrpg from the ground up</h2>
    ...
    <section className="navigation flex flex-col w-full">
      <ul className="flex border-b">
        <li className="mb-px mr-1">
          ...
          <NavLink
            className=" inline-block border-l border-t border-r rounded-t py-2 px-4 bg-slate-50 text-slate-800 font-semibold"
            to="#"
        ...
        <li className="mr-1">
          <NavLink
            className="bg-slate-100 border-l border-t border-r rounded-t inline-block py-2 px-4 text-slate-500 hover:text-slate-800 font-semibold"
            to="#"
        ...
        <li className="mr-1">
          <NavLink
            className="bg-slate-200  border-l border-t border-r rounded-t inline-block py-2 px-4 text-slate-500 hover:text-slate-800 font-semibold"
            to="#"
      ...
      <div className="flex bg-slate-50 text-slate-800 text-left justify-end gap-2 min-h-screen pl-6">
        <div className="ramble bg-slate-50 overflow-hidden transition-all " id="ramble">
          <Ramble />
          
        </div>
        <div className="design bg-slate-100 overflow-hidden transition-all " id="design">
         <Design />
         
        </div>
        <div
          className="publish bg-slate-200 overflow-hidden transition-all"
          id="publish"
        >
          <Publish />
        </div>
